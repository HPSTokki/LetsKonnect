...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Dec 08, 2024 at 02:17 PM
...
(1, 1, 'Sora', 'Tokki', 'Kimi', 'NoYawa', 20, '2004-07-08', 'Female');
...
(1, 1, 'AIWDJWAJDODOADoi', 'Sitio 2', 'sorachisenpai@gmail.com', 934237293);
...
(1, 1, 'Single', 'Child Youth (15-17 yrs old)', 'College Graduate', 'In School Youth', 'Unemployed', 'Yes', 'Yes');
...
(1, 1, 'College Graduate', 'SBHSEGH', 'Yes', 'No', '');
...
(1, 1, 'image-1733653936929.png', 'uploads\\image-1733653936929.png', 'Sora Kimino Yawa');
...
(1, 'sorachisenpai@gmail.com', 'RainAlexander16', 18, '2024-12-08', NULL, NULL);
...
--
ALTER TABLE `kk_personalinfo5`
  MODIFY `kk_personaInfo5` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `kk_personalinfo6`
--
ALTER TABLE `kk_personalinfo6`
  MODIFY `kk_personaInfo6` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_usersacc`
  MODIFY `userAcc_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
